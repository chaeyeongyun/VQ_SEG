    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx in pbar:
            ...
            with torch.cuda.amp.autocast(enabled=half):
                pred_sup_1, commitment_loss_l1, code_usage_l1, usage_loss_l1 = model_1(l_input, code_usage_loss=True)
                pred_sup_2, commitment_loss_l2, code_usage_l2, usage_loss_l2 = model_2(l_input, code_usage_loss=True)
                ## predict in unsupervised manner ##
                pred_ul_1, commitment_loss_ul1, code_usage_ul1, usage_loss_ul1 = model_1(ul_input, code_usage_loss=True)
                pred_ul_2, commitment_loss_ul2, code_usage_ul2, usage_loss_ul2 = model_2(ul_input, code_usage_loss=True)
                if batch_idx == 0:
            ...
            with torch.cuda.amp.autocast(enabled=half):
                ...
                usage_loss = usage_loss_l1 + usage_loss_l2 + usage_loss_ul1 + usage_loss_ul2
                ...
                loss = sup_loss + cps_loss_weight*cps_loss + total_commitment_loss_weight*commitment_loss + usage_loss
