...
from models.modules.prototype import PrototypeLoss, EuclideanPrototypeLoss
...
class VQEuPTUnet(nn.Module):
    def __init__(
        ...
        self.segmentation_head = SegmentationHead(in_channels=decoder_channels[-1],
                                                  ...
                                                  activation=activation,
                                                  kernel_size=3)
        self.prototype_loss = EuclideanPrototypeLoss(num_classes, decoder_channels[-1], use_feature=use_feature)
