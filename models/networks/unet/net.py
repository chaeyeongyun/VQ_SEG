...
from models.modules.prototype import PrototypeLoss, EuclideanPrototypeLoss, LearnableEuclideanPrototypeLoss
...
class VQATUnet(nn.Module):
    def __init__(
        ...
        self.attention = make_attentions(DualAttention, encoder_channels[1:], flag)
