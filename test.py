...
if __name__ == "__main__":
    ...
    w_l = ["../drive/MyDrive/semi_sup_train/IJRR2017/VQRePTUnet1x1_IJRR20171/ckpoints/best_test_miou.pth", "../drive/MyDrive/semi_sup_train/rice_s_n_w/VQRePTUnet1x1_rice_s_n_w0/ckpoints/best_test_miou.pth"]
