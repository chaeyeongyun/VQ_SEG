...
def train(cfg):
    ...
    total_seghead_commit_loss_weight = cfg.train.total_seghead_commit_loss_weight
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx in pbar:
            ...
            with torch.cuda.amp.autocast(enabled=half):
                pred_sup_1, commitment_loss_l1, code_usage_l1, angular_loss_l1, seghead_commit_loss_l1 = model_1(l_input, l_target)
                pred_sup_2, commitment_loss_l2, code_usage_l2, angular_loss_l2, seghead_commit_loss_l2 = model_2(l_input, l_target)
                ## predict in unsupervised manner ##
                pred_ul_1, commitment_loss_ul1, code_usage_ul1, angular_loss_ul1, seghead_commit_loss_ul1 = model_1(ul_input, pseudo_2)
                pred_ul_2, commitment_loss_ul2, code_usage_ul2, angular_loss_ul2, seghead_commit_loss_ul2 = model_2(ul_input, pseudo_1)
                if batch_idx == 0:
            ...
            with torch.cuda.amp.autocast(enabled=half):
                ...
                ## seghead_commit_loss
                seghead_commit_loss = seghead_commit_loss_l1 + seghead_commit_loss_l2 + seghead_commit_loss_ul1 + seghead_commit_loss_ul2
                seghead_commit_loss *= total_seghead_commit_loss_weight
                ...
                loss = sup_loss + cps_loss_weight*cps_loss + commitment_loss + angular_loss + seghead_commit_loss
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config_path', default='./config/vqashv2.json')
