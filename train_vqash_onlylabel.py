    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx in pbar:
            ...
            with torch.cuda.amp.autocast(enabled=half):
                ...
                pred_ul_1, commitment_loss_ul1, code_usage_ul1, _ = model_1(ul_input)
                pred_ul_2, commitment_loss_ul2, code_usage_ul2, _ = model_2(ul_input)
                if batch_idx == 0:
            ...
            with torch.cuda.amp.autocast(enabled=half):
                ...
                ## angular_loss
                angular_loss = angular_loss_l1 + angular_loss_l2 
